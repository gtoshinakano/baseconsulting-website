...
const HomeHero = () => {
  ...
  useEffect(() => {
    ...
    gsap.set(scrollDist.current, {width:'100%', height:'200%'})
    gsap.timeline({scrollTrigger:{trigger:scrollDist.current, start:'top top', end:'bottom bottom', scrub:1}})
    ...
    <Container ref={cover}>
      ...
      <div className="main" ref={main}>
        <svg viewBox="0 0 1200 800" xmlns="http://www.w3.org/2000/svg">
          ...
          <Text fill="#fff" x="50%" y="200" alignmentBaseline="middle" textAnchor="middle">{t("baseconsulting")}</Text>
          <polyline className="arrow" fill="#fff" points="599,250 599,289 590,279 590,282 600,292 610,282 610,279 601,289 601,250" />
          
          <g mask="url(#m)">
            <rect fill="#fff" width="100%" height="100%" />      
            <Text x="50%" y="200" fill="#162a43"  alignmentBaseline="middle" textAnchor="middle">{t("welcome")}</Text>
          </g>
